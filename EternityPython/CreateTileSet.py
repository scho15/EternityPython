...
def matchTwoPatterns(x,y):
    twoPatternsList = []
    if (x != y):
        twoPatternsList.append(list(tilePatternList[x].intersection(tilePatternList[y])))
    print(f"Two matching edges are {twoPatternsList}")
